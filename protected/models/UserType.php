 ...
 * @property string $UserTypeLabelEn
 */
class UserType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('UserTypeLabelEn', 'required'),
			array('UserTypeLabelEn', 'length', 'max'=>40),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('UserTypeId, UserTypeLabelEn', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'UserTypeLabelEn' => 'User Type Label En',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('UserTypeLabelEn',$this->UserTypeLabelEn,true);
